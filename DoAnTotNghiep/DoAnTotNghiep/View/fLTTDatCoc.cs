...
{
    public partial class fLTTDatCoc : Form
    {
        ...
        public fLTTDatCoc(PhieuDatCocDTO PDCXuLy)
        {
            InitializeComponent();
            this.PDCXuLy = PDCXuLy;
        }

        private void fLTTDatCoc_Load(object sender, EventArgs e)
        {
            txtID.Visible = false;
            DataTable dataLTT = PhieuDatCocDAO.Instance.GetLichThanhToanByIDPDC(this.PDCXuLy.Id);

            dgvDanhMucLichThanhToan.DataSource = dataLTT;
            dgvDanhMucLichThanhToan.Columns["id"].HeaderText = "ID";

            dgvDanhMucLichThanhToan.Columns["idphieudatcoc"].HeaderText = "ID Phiếu Đặt Cọc";
        ...
        void Bingding()
        {
            ...
            txtIDPDC.DataBindings.Clear();
            txtIDPDC.DataBindings.Add("Text", dgvDanhMucLichThanhToan.DataSource, "idphieudatcoc", true, DataSourceUpdateMode.Never);
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (txtIDPDC.Text == "")
            {
                txtIDPDC.Text = PDCXuLy.Id.ToString();
            }
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                // xoa
                if (PhieuDatCocDAO.Instance.XoaLTTDatCoc(int.Parse(txtID.Text)))
                {
        ...
        private void btnThucHien_Click(object sender, EventArgs e)
        {
            try
            {
                int idphieudatcoc = int.Parse(txtIDPDC.Text);
                ...
                if (flag == 1)
                {
                    ...
                    if (PhieuDatCocDAO.Instance.ThemLTTDatCoc(idphieudatcoc, ngaythu, sotien, phantram, trangthai, anhphieuthu, ghichu))
                    {
                ...
                if (flag == 2)
                {
                    ...
                    double sotien = double.Parse(txtSoTien.Text);
                    double phantram = double.Parse(txtPhanTram.Text);
                    if (PhieuDatCocDAO.Instance.SuaLTTDatCoc(id, idphieudatcoc, ngaythu, sotien, phantram, trangthai, anhphieuthu, ghichu))
                    {
        ...
        private void fLTTDatCoc_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void txtSoTien_TextChanged(object sender, EventArgs e)
        {
            ...
            double sotien = double.Parse(txtSoTien.Text);
            double tiencoc = PhieuDatCocDAO.Instance.GetTienCoc(PDCXuLy.Id);
