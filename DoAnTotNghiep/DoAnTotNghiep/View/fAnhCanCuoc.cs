...
{
    public partial class fAnhCanCuoc : Form
    {
        ...
        public fAnhCanCuoc(KhachHangDTO KhachHangXuLy)
        {
            InitializeComponent();
            this.KhachHangXuLy = KhachHangXuLy;
        }

        private void fAnhCanCuoc_Load(object sender, EventArgs e)
        {

            txtID.Enabled = false;
            txtIDKhachHang.Enabled = false;
            DataTable dataAnh = KhachHangDAO.Instance.GetListAnhCanCuoc(this.KhachHangXuLy.Id);
            ...
            dgvDanhMucAnh.Columns["anhcancuoc"].HeaderText = "Ảnh Căn Cước";
        ...
        void Bingding()
        {
            ...
            pbAnh.DataBindings.Add("Image", dgvDanhMucAnh.DataSource, "anhcancuoc", true, DataSourceUpdateMode.Never);
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                // xoa
                if (KhachHangDAO.Instance.XoaAnhCanCuoc(txtID.Text))
                {
        ...
        private void btnThucHien_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var anhcancuoc_tmp = new ImageConverter().ConvertTo(pbAnh.Image, typeof(Byte[]));
                ...
                if (flag == 1)
                {
                    ...
                    if
                    (
                        KhachHangDAO.Instance.ThemAnhCanCuoc(idkhachhang, anhcancuoc)
                    )
                    {
                ...
                if (flag == 2)
                {
                    ...
                    if
                    (
                        KhachHangDAO.Instance.SuaAnhCanCuoc(id, anhcancuoc)
                    )
                    {
        ...
        private void fAnhCanCuoc_FormClosing(object sender, FormClosingEventArgs e)
        {
