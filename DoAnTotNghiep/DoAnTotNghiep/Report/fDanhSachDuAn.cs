...
{
    public partial class fDanhSachDuAn : Form
    {
        public fDanhSachDuAn()
        {
            InitializeComponent();
        }
        string query = "SELECT * FROM v_DAChiTiet WHERE 1 = 1";

        private void fDanhSachDuAn_Load(object sender, EventArgs e)
        {
            LoadComBoBox();
            LoadReport(query);
        ...
        public void LoadReport(string query)
        {
            ...
            rptBieuMau.LocalReport.ReportEmbeddedResource = "DoAnTotNghiep.Report.rptDuAn.rdlc";

            if (dsDanhSach.Tables[0].Rows.Count > 0)
            {
                ReportDataSource rds = new ReportDataSource();
                rds.Name = "v_DAChiTiet";
        ...
        private void fDanhSachDuAn_FormClosing(object sender, FormClosingEventArgs e)
        {
